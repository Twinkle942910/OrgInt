...
public class ToDoRecycleAdapter extends RecyclerView.Adapter<ToDoRecycleAdapter.ToDoViewHolder> implements View.OnClickListener
{
    ...
    public ToDoRecycleAdapter( List<ToDo> todos, Context context)
    {
        this.todos = todos;
    ...
    public ToDoViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        toDoViewHolder.setActivity((ToDoActivity)context);
    ...
    public void onBindViewHolder(ToDoViewHolder holder, int position)
    {
        ...
        {
            holder.coment.setText(todos.get(position).getComment());
        ...
        sub_tasks_count_text.setText(Integer.toString(checked_sub_tasks_count) + "/" + Integer.toString(todos.get(position).getSubTasksCount()));
    }

    //Checks if there is comment
    private boolean isComment()
    {
        return "".equals(todos.get(todo_item_position).getComment());
    }

    //Checks if there are syb tasks
    private boolean isSubTasks()
    {
        return todos.get(todo_item_position).getSub_tasks().isEmpty();
    }
    ...
    {
        holder.todo_task.setText(todos.get(todo_item_position).getTask());
        holder.todo_type.setText(todos.get(todo_item_position).getType());
        holder.todo_date.setText(todos.get(todo_item_position).getDate() + " " + todos.get(todo_item_position).getTime());
    }
    ...
    {
        //Adding sub tasks
        for (int i = 0; i < todos.get(todo_item_position).getSubTasksCount(); i++)
        {
            ...
            child_sub_task_task.setText(todos.get(todo_item_position).getSub_task(i).getContent());

            //in some cases, it will prevent unwanted situations
            child_sub_task_isdone.setOnCheckedChangeListener(null);
            child_sub_task_isdone.setChecked(todos.get(todo_item_position).getSub_task(i).isDone());
            child_sub_task_isdone.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    todos.get(todo_item_position).getSub_task(sub_task_item_position).setDone(isChecked);
                    ...
                    sub_tasks_count_text.setText(Integer.toString(checked_sub_tasks_count) + "/" + Integer.toString(todos.get(todo_item_position).getSubTasksCount()));
    ...
    {
        if(checked_sub_tasks_count == todos.get(todo_item_position).getSubTasksCount())
        {
    ...
    public static class ToDoViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public ToDoViewHolder(View itemView)
        {
            ...
            subTasksAndComentLayout = (LinearLayout)itemView.findViewById(R.id.sub_tasks_and_coments_lay);
        ...
        public  void addSubTask()
        {
            ...
            View subTaskView = layoutInflater.inflate(R.layout.sub_task_todo, null);
        ...
        public void setActivity(ToDoActivity activity)
        {
